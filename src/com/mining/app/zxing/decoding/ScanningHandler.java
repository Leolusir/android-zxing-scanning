...
import com.example.zdemo.R;
import com.example.zdemo.ScanningActivity;
...
public final class ScanningHandler extends Handler {
  ...
  public ScanningHandler(ScanningActivity activity, Vector<BarcodeFormat> decodeFormats,
      String characterSet) {
